...
function createTaskCard(task) {
    ...
    //     taskCard.addClass("due-soon");
    // } else (taskCard.addClass("present"));
...
// Make task cards draggable and properties
...
function handleDrop(event, ui) {
    ...
    // 'ui' contains information about the draggable element that was dropped

    var droppedElement = ui.draggable; // The element that was dragged and dropped
    var targetLane = $(this); // The element with the 'lanes' class that was dropped on

    // Example of what you might do in the drop handler
    droppedElement.remove(); // Remove the dragged element
    targetLane.append(droppedElement); // Append it to the target lane
